...
RF_model <- train(factor(TARGET)~., data=train_data, method="rf",tuneLength = 50, 
                   metric = "Accuracy",
                   trControl = fitControl)
...
# Deployment
>>>>>>> 374008ddf6aad0a9a242942a8d996a12fba2f9a7
...
print(modellist[4])
# Predict Test results
RF2_model.pred <- predict(modellist$`2500`, test_data)
RF2_model.pred
# Check Accuracy of Model 
