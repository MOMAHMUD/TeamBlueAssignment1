...
data<-read.csv('C:/Users/benny/OneDrive/Machine Learning/ML1000/Assignments/Assignment 1/Assignment 1 Data/processed.cleveland.data.csv',header = TRUE, na.strings = c("NA","","#NA","?"))
data2<-read.csv('C:/Users/benny/OneDrive/Machine Learning/ML1000/Assignments/Assignment 1/Assignment 1 Data/processed.hungarian.data.csv', header = TRUE, na.strings = c("NA","","#NA","?"))
data3<-read.csv('C:/Users/benny/OneDrive/Machine Learning/ML1000/Assignments/Assignment 1/Assignment 1 Data/processed.switzerland.data.csv', header = TRUE, na.strings = c("NA","","#NA","?"))
data4<-read.csv('C:/Users/benny/OneDrive/Machine Learning/ML1000/Assignments/Assignment 1/Assignment 1 Data/processed.va.data.csv', header = TRUE, na.strings = c("NA","","#NA","?"))
#Add recorid
